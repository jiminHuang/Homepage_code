...
def test_get_connection(mock_config, mock_connection, mock_error):
    ...
    mock_error.assert_called_with('Mysql Connection Error: class test_c db not assigned')
...
class TestPersistence(object):
    ...
    def test_background_chew(self):
        ...
        assert_equal(background.background_type, database.Background.BACKGROUND_TYPE[1])
